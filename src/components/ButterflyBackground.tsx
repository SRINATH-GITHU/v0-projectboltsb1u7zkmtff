...
const ButterflyBackground: React.FC<ButterflyBackgroundProps> = ({ isFlying = false }) => {
  return (
    <>
      <section className="background"></section>
      
      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" xmlSpace="preserve" className="svg-defs">
        <defs>
          <pattern id='image' width="1" height="1" viewBox="0 0 100 100" preserveAspectRatio="none">
            <image xlinkHref="https://s3-us-west-2.amazonaws.com/s.cdpn.io/78881/pattern_141.gif" width="100" height="100" preserveAspectRatio="none"></image>
          </pattern>
          
          <g id="shape-butterfly-1">
            <path className="path" fill="" clipRule="evenodd" d="M8.65,2.85c0.934-0.2,2.15-0.333,3.65-0.4c1.534-0.1,2.667-0.083,3.4,0.05
      ...
      <section className="scene3d">
        ...
        <div className={`butterfly_container ${isFlying ? 'flying-away' : ''}`}>
                ...
                <var className="translate3d-1">
                  <figure className="butterfly">
                    <svg className="wing left" viewBox="0 0 50 100">
                      <use className="left" xlinkHref="#shape-butterfly-1"></use>
                    </svg> 
        ...
        <div className={`butterfly_container scale_half ${isFlying ? 'flying-away' : ''}`}
             style={{
               marginTop: '-10px', 
               marginLeft: '50px',
               WebkitAnimationDuration: '5s',
        ...
        <div className={`butterfly_container scale_third ${isFlying ? 'flying-away' : ''}`}
             style={{
               marginTop: '150px',
               WebkitAnimationDuration: '20s',
               MozAnimationDuration: '20s',
